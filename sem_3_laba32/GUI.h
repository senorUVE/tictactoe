...
void printBoard(RenderWindow* window, std::vector<sf::Sprite>& sprites)
{
    ...
    font.loadFromFile("C:/Users/Kokovino/Desktop/tictac/sem_3_laba32/arial.ttf");
...
{   int set;
    ...
    Texture texture;
    texture.loadFromFile("C:/Users/Kokovino/Desktop/tictac/Images/Magnus.jpg");
    Sprite sprite;
    ...
    while (window.isOpen())
    {
        ...
        {   Text text1("Tic Tac Toe",font);
            ...
            Text text2("Classic",font);
            text2.setCharacterSize(50);
            text2.setPosition(160,365);
            text2.setFillColor(Color::White);

            Text text3("Universities",font);
            text3.setCharacterSize(50);
            text3.setPosition(725,620);
            text3.setFillColor(Color::White);

            Text text4("Disco",font);
        ...
        if (set==1)
        {
            pict1 = "C:/Users/Kokovino/Desktop/tictac/Images/cross.png";
            pict2 = "C:/Users/Kokovino/Desktop/tictac/Images/nol.png";
        }

        else if (set==2)
        {
            pict1 = "C:/Users/Kokovino/Desktop/tictac/Images/logo.png";
            pict2 = "C:/Users/Kokovino/Desktop/tictac/Images/logo1.png";
        }

        else if (set==3)
        {
            pict1 = "C:/Users/Kokovino/Desktop/tictac/Images/kupol.jpg";
            pict2 = "C:/Users/Kokovino/Desktop/tictac/Images/discoball.png";
        }
